...
<head>
    <meta charset="UTF-8">
    <title>Politique de Confidentialité - StageBoard</title>
    <link rel="stylesheet" href="style.css">
    <style>
        body { background: #f9f9f9; padding: 40px 20px; color: #333; }
        ...
        h1 { color: #2557a7; border-bottom: 2px solid #eee; padding-bottom: 10px; }
        h2 { margin-top: 30px; font-size: 1.2rem; color: #444; }
        p { line-height: 1.6; color: #555; }
        .btn-back { display: inline-block; margin-bottom: 20px; color: #2557a7; text-decoration: none; font-weight: bold; }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <p>Nous recueillons des informations lorsque vous vous inscrivez sur notre site, lorsque vous vous connectez à votre compte, et lorsque vous postulez à une offre. Les informations recueillies incluent votre nom, votre adresse e-mail et votre numéro de téléphone.</p>
    ...
    <p>Nous mettons en œuvre une variété de mesures de sécurité pour préserver la sécurité de vos informations personnelles (chiffrement des mots de passe, sessions sécurisées).</p>
